...
-- General keymaps
keymap.set("i", "kj", "<ESC>") -- exit insert mode with jk
...
keymap.set("n", "<leader>n6", function()
	require("harpoon.ui").nav_file(6)
end)
keymap.set("n", "<leader>n7", function()
	require("harpoon.ui").nav_file(7)
end)
keymap.set("n", "<leader>n8", function()
	require("harpoon.ui").nav_file(8)
end)
keymap.set("n", "<leader>n9", function()
